...
typedef enum
{
    ...
    TEST_HASH_SHA2_384,
    TEST_HASH_SHA2_512,
    TEST_HASH_SHA2_512_224,
    TEST_HASH_SHA2_512_256,
    TEST_HASH_SHA3_224,
    TEST_HASH_SHA3_256,
    TEST_HASH_SHA3_384,
    TEST_HASH_SHA3_512,
...
void test_hash_1(void)
{
    ...
    for(test_hash_t hash = TEST_HASH_START + 1; hash < TEST_HASH_END; hash++)
    {
        ...
        if((hash == TEST_HASH_SHAKE_128) || (hash == TEST_HASH_SHAKE_256))
